...
def main():
    ...
    for epoch in range(opt.num_epochs):
        ...
        for sample in tqdm(train_dataloader):
            ...
            for i in range(opt.batch_size):
                for j in range(5):
                    ...
                    loss_mask += bcecriterion(masks[i,j,id_slot,:,:], mask_gt[i,j,id_gt,:,:])
            ...
            del recon_combined, masks, image, loss, whole_loss, mask_gt, loss_mask
            # break
        ...
        print ("Epoch: {}, Loss: {}, Loss_mask: {}, Time: {}".format(epoch, total_loss,M_loss,
